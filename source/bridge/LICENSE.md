# Embedded Addons Bridge License
...
The complete LGPL v3 license text is also included in this repository at
[`../gtna/LICENSE.MD`](../gtna/LICENSE.MD) and is available from the Free
Software Foundation:

<https://www.gnu.org/licenses/lgpl-3.0.html>

When redistributing the bridge, preserve this notice and provide the full
LGPL-3.0 license text as required by the license. The repository-level
[`LICENSE-NOTICE.md`](../../LICENSE-NOTICE.md) explains the separate licenses
that apply to the merged JAR.
