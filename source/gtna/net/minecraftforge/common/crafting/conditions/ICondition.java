...
public interface ICondition {
    Codec<ICondition> CODEC = ExtraCodecs.m_184415_(() -> ForgeRegistries.CONDITION_SERIALIZERS.get().getCodec().dispatch(ICondition::codec, Function.identity()));
    ...
    interface IContext {
        ...
        default <T> Collection<Holder<T>> getTag(TagKey<T> key) {
            return getAllTags(key.f_203867_()).getOrDefault(key.f_203868_(), Set.of());
        }
