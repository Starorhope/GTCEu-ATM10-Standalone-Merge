...
public class LargeSteamCompressor extends SteamMultiMachineBase {


    @SaveField
    private int targetParallel = 24;

    public LargeSteamCompressor(BlockEntityCreationInfo holder, Object... args) {
        super(holder, false, args);
    }

    @Nullable
    public static ModifierFunction recipeModifier(MetaMachine machine, @Nonnull GTRecipe recipe) {
        if (!(machine instanceof LargeSteamCompressor steamMachine)) {
