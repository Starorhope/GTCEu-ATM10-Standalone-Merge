...
public class HugeSteamInputBus extends MultiblockPartMachine implements IMuiMachine {

    @SaveField
    public final NotifiableItemStackHandler inventory;

    public HugeSteamInputBus(BlockEntityCreationInfo holder, Object... args) {
        super(holder);
        this.inventory = attachTrait(new NotifiableItemStackHandler(64, IO.IN, IO.IN));
    }
